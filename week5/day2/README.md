## Week 5 Day 2: Firebase auth


### Labs:

- [Products App with Auth](https://git.generalassemb.ly/FEPIR-LOL-Saudi/firebase-product-app-with-login)

- [Firebase Products App CRUD Lab](https://git.generalassemb.ly/FEPIR-LOL-Saudi/firebase-crud-products-app)

- [Firebase Art Gallery App](https://git.generalassemb.ly/FEPIR-LOL-Saudi/firebase-art-gallery-carousel)
