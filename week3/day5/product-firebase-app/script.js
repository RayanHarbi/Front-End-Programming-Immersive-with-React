...
function getProducts() {
    ...
    db.collection('test-products').get()
        .then(products => {
...
function deleteProduct(productId) {
    ...
    db.collection("test-products").doc(productId).delete()
        .then(deletedProduct => {
...
function showModifyProduct(productId) {
    ...
    db.collection("test-products").doc(productId.id).get()
        .then(product => {
...
function updateProduct(productId) {
    ...
    db.collection('test-products').doc(productId.id).update({
        name: name,
...
document.querySelector('#search-btn').addEventListener('click', function (e) {
    ...
    db.collection("test-products").where("name", "==", search).get()
        .then(products => {
