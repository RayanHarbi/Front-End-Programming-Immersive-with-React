...
- Write a variable called `favoriteActivity`.
- Display the presentation in a sentence using concatenation: `My imaginary cat's name is Rainbow, he is 1 year old, and he is always Dancing.`
- Then write a variable  called `presentation` and assign all the previous variables along with a sting concatenation.
- Then call the the variable `presentation` with `console.log(presentation)`.
...
- Declare a variable that contains a random number from 1 to 6 like a dice
